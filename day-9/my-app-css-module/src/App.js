...
class App extends Component {
  ...
  render() {
    ...
    if (this.state.persons.length <= 2) {
      classes.push(cssclass.red); // ["red"]
    }
    if (this.state.persons.length <= 1) {
      classes.push(cssclass.bold); //['red, 'bold']
    }
    ...
    return (
      ...
      <div className={cssclass.App}>
        ...
        <button className={cssclass.button} onClick={this.togglePersonHandler}>Toggle Persons</button>
